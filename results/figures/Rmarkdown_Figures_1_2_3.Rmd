...
### Figure 1a
Number of smolt and adults by age vs smolt migration year
...
Stacked bars numbers and proportionsfor T/ROR (no smolt year)
```{r}
# bar numbers
...
proportion for T/ROR wrapped by year
```{r}
